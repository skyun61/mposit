// Testbench for decode_pacogen

`timescale 1ns / 1ps

module decode_pacogen_tb;
	parameter N = 8;
	...
	wire [W-1:0] m;
	decode_pacogen #(N, ES) u1 (in, sign, exp, efrac, special);
	...
	assign in = {in_sign, REF};		// decoder input
	
	initial begin
		$display("-------- decode pacogen(%2d,%1d) -----------", N, ES);
